<template>
  <div class="r-pager" :class="{hide: hideIfOnePage === true && totalPage <= 1}">
    <span class="r-pager-nav prev" :class="{disabled:currentPage===1}"
    ...
    <span class="r-pager-nav next" :class="{disabled: currentPage===totalPage}"
      @click="onClickPage(currentPage+1)">
